...
const en = {
  ...
  visaGranted: "Granted",
  visaRefused: "Refused",
  visaLodged: "Applied, awaiting decision",
...
const ml: Record<keyof typeof en, string> = {
  ...
  conditionalOffer: "നിബന്ധനകളോടെയുള്ള ഓഫർ",
  unconditionalOffer: "നിബന്ധനകളില്ലാത്ത ഓഫർ",
  acceptBy: "സ്വീകരിക്കേണ്ട അവസാന തീയതി",
  conditions: "പാലിക്കേണ്ട നിബന്ധനകൾ",
  visa: "വിസ",
  visaGranted: "അനുവദിച്ചു",
  visaRefused: "നിരസിച്ചു",
  visaLodged: "അപേക്ഷിച്ചു, തീരുമാനം കാത്തിരിക്കുന്നു",
  ...
  sharedWithYou: "നിങ്ങൾക്കായി പങ്കിട്ടവ",
  seeSample: "മാതൃക കാണുക",
  openFile: "തുറക്കുക",
