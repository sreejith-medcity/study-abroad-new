...
export const IMPORT_KINDS = {
  students: {
    ...
    columns: [
      ...
      ["name", "The whole name in one column, where you do not have it split. The last word is taken as the surname"],
      ["first_name", "Required, unless the name column carries the whole name"],
      ["last_name", "Required, unless the name column carries the whole name"],
      ...
      ["consent", "yes, for a new student, to confirm the branch has the student's consent. Leave the column out and tick the confirmation above the file instead"],
