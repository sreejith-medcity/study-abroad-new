...
const FALLBACK_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect width="32" height="32" rx="7" fill="#c01f53"/><path d="M8 25C8 16 12.4 9.3 20.2 6.3c-.9 4.2-2.5 7.4-4.7 9.9C13.3 18.7 10.8 21.6 8 25z" fill="#f7ec22"/><path d="M14 25c0-7.7 3.8-13.6 11.1-16.6-.9 3.9-2.4 7-4.5 9.4C18.6 20.2 16.4 22.5 14 25z" fill="#fff"/></svg>`;
